...
const card = (props) => {
    return (
        <div   className='lg:w-[23vw] md:w-[30vw] sm:w-[45vw] h-60 rounded-xl py-8 px-8 flex items-center flex-col text-center bg-white text-black'>
            ...
            <p className='text-sm font-medium leading-tight'>{props.elem.userDisc}</p>
            <button  onClick={()=>{
              props.deleteElem(props.idx)
